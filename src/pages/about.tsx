...
import photo from "../assets/img/about/bg.png";
...
const About: React.FC<TProps> = ({ setTheme }) => {
          ...
          <Container lBorder>
            ...
            <div className="flex justify-between items-center h-max">
              <div className="flex flex-col w-[50%] py-12">
                ...
                На нашем сайте вы найдете большую коллекцию произведений искусства, которые охватывают разные эпохи и культуры. Мы собрали для вас лучшие работы известных мастеров, чтобы вы смогли насладиться ими вместе с нами
                </p>
        ...
        <div className="mb-20" id="targets">
          ...
          <Container border>
            <div className="mb-16">
              ...
              Одна из главных целей - донесение знаний о искусстве и культуре до широкой аудитории. Музей должен предоставлять информацию о картинах, скульптурах, архитектуре, музыке и других формах искусства, а также контекст их создания и историческое значение. Цель заключается в том, чтобы помочь людям понять значение искусства в их жизни и в контексте общества в целом.
              </div>
            </div>
          </Container>
          <Container border>
            <div className="mb-16">
              ...
              <div className="text-link w-[90%] text-lg">
              Вторая цель - вдохновить своих посетителей на творчество и самовыражение. Сайт должен стать источником вдохновения для людей, показав им красоту и многогранность искусства и культуры. В своих экспозициях музей может использовать различные приемы, чтобы вызвать у посетителей эмоции, включая использование цвета, формы, света и звука
              </div>
            </div>
          </Container>
          <Container border>
            <div className="mb-16">
              ...
              <div className="text-link w-[90%] text-lg">
              Третья цель - сделать искусство и культуру доступными для всех. В целом, сайт должен стать инструментом, который улучшает культурную грамотность и образование людей, а также помогает им обретать новые взгляды на искусство и мир вокруг нас.
              </div>
            </div>
          </Container>
        </div>
